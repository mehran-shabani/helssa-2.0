...
urlpatterns = [
    ...
    path("telemedicine/pay/webhook", telemedicine_views.bitpay_webhook, name="telemedicine-bitpay-webhook"),
    path("telemedicine/pay/verify", telemedicine_views.bitpay_verify, name="telemedicine-bitpay-verify"),
]
